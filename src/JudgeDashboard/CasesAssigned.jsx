...
export default function AssignedCases() {
  ...
  return (
    <div className="admin-dashboard" style={{ padding: 0, margin: 0, minHeight: "100vh" }}>
      ...
      {/* Rest of AssignedCases content remains unchanged */}
      <div className="admin-content" style={{ marginTop: "-59px", minHeight: "100vh" }}>
        {/* Sidebar */}
        <aside className="admin-sidebar" style={{ width: "250px" }}>
          <ul className="admin-nav">
            <li onClick={() => navigate('/judgedashboard')}><FaHome /> Home</li>
            <li className="active"><FaClipboardList /> Assigned Cases</li>
              ...
              <table className="table table-striped">
                ...
                <tbody>
                  ...
                  {currentCases.length === 0 && (
                    <tr>
                      <td colSpan="6" style={{ textAlign: 'center' }}>No assigned cases found</td>
                    </tr>
                  )}
                </tbody>
              </table>
