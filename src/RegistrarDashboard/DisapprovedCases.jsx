...
export default function DisapprovedCases() {
        ...
        >
          ...
          <div className="offcanvas-body">
            <ul className="list-group">
              ...
              <li className="list-group-item active" onClick={() => navigate("/disapprovedcases")}>
      ...
      <div className="admin-content" style={{ marginTop: "-59px" }}>
        ...
        <aside className="admin-sidebar" style={{ width: "300px" }}>
          <ul className="admin-nav">
            ...
            <li className="active" onClick={() => navigate("/disapprovedcases")}>
              <FaTimesCircle /> Disapproved Cases
            </li>
